      ...
      generate: {
        options: {
          ...
          cache: [
            ...
            '/game.css',
            '/imgs/Chess-blackBishop.png',
            '/imgs/Chess-blackKing.png',
            '/imgs/Chess-blackKnight.png',
            '/imgs/Chess-blackPawn.png',
            '/imgs/Chess-blackQueen.png',
            '/imgs/Chess-blackRook.png',
            '/imgs/Chess-darkCell.svg',
            '/imgs/Chess-lightCell.svg',
            '/imgs/Chess-whiteBishop.png',
            '/imgs/Chess-whiteKing.png',
            '/imgs/Chess-whiteKnight.png',
            '/imgs/Chess-whitePawn.png',
            '/imgs/Chess-whiteQueen.png',
            '/imgs/Chess-whiteRook.png',
          ],
